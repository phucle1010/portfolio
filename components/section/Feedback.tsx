        ...
        >
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="group bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-10 md:p-12 hover:bg-white/10 hover:border-cyan-500/30 hover:shadow-[0_8px_30px_rgba(6,182,212,0.15)] transition-all duration-300 hover:-translate-y-1 relative overflow-hidden"
            >
              {/* Decorative gradient corner */}
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-cyan-500/10 via-teal-500/10 to-blue-500/10 blur-3xl rounded-full -translate-y-1/2 translate-x-1/2"></div>
              ...
              <div className="pt-6 border-t border-white/10 flex items-center justify-between relative z-10">
                ...
                {feedback[currentIndex].image && (
                  <div className="relative w-20 h-20 rounded-full overflow-hidden border-2 border-cyan-500/30 ring-2 ring-cyan-500/20">
                    <Image
